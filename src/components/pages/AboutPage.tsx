...
import { MapPin, Phone, Mail, Users, Target, Zap, Heart } from 'lucide-react';
...
const futureGoals = [
  { id: 1, goal: "AI Integration Leadership", description: "Become the leading provider of AI-powered business automation solutions in Southeast Asia" },
  { id: 2, goal: "Regional Expansion", description: "Expand our client base across Southeast Asia, serving businesses of all sizes with innovative technology solutions" },
  { id: 3, goal: "Remote-First Excellence", description: "Build a world-class remote team that delivers exceptional results for clients globally" },
  { id: 4, goal: "Technology Accessibility", description: "Make enterprise-grade technology solutions accessible and affordable for small and medium businesses" },
  { id: 5, goal: "Industry Recognition", description: "Establish Tepa Solutions as a recognized leader in business technology transformation and innovation" },
  { id: 6, goal: "Community Impact", description: "Give back to our community through pro-bono work for non-profits and mentorship opportunities for young professionals" }
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-b from-muted/30 to-background py-20">
        <div className="container mx-auto px-6">
          ...
          >
            <Badge className="mb-4">About Tepa Solutions</Badge>
           
            <p className="text-xl text-muted-foreground">
              Named after our founder's beloved late grandmother, Tepa Solutions is a growing 
              technology startup founded in 2024, dedicated to transforming businesses through 
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <div className="space-y-6 text-center">
              ...
              <div className="bg-gradient-to-r from-primary/5 to-primary/10 p-8 rounded-lg mt-8">
                ...
                <p className="text-primary font-medium mt-4">— Jerrie M., Founder & CEO</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      {/* Office Location */}
      <div className="py-16" id="office-locations">
        <div className="container mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">
              Let's discuss how we can help streamline your operations and accelerate your growth with innovative technology solutions. 
