import { generateKeywords } from '../components/seo4-head';
...
export const SEO_CONFIG = {
  main: {
    ...
    structuredData: {
      ...
      "@type": "TechCompany",
      "@id": "https://tepasolutions.asia/#company",
      "name": "Tepa Solutions",
...
export const createBreadcrumbs = (path: string[]): Array<{ name: string; url: string }> => {
  const breadcrumbs = [{ name: 'Home', url: 'https://tepasolutions.asia' }];
  
  let currentPath = 'https://tepasolutions.asia';
